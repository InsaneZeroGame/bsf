...
function(add_engine_dependencies2 target_name all_render_api)
	if(${all_render_api})
		if(WIN32)
			add_dependencies(${target_name} bsfD3D11RenderAPI bsfVulkanRenderAPI bsfGLRenderAPI kD3D12RenderAPI)
		elseif(APPLE)
		...
		elseif(RENDER_API_MODULE MATCHES "DirectX 12")
			add_dependencies(${target_name} kD3D12RenderAPI)
		else()
			add_dependencies(${target_name} bsfGLRenderAPI)
		endif()
	endif()
